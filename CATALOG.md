...
**7** plugins · **9** agents · **35** skills · **4** hooks
...
| [`browser`](plugins/core-skills/skills/browser/SKILL.md) 📜 📚 | skill | `core-skills` | Drives interactive websites in a dedicated signed-in browser window, isolated from the user's other windows. |
...
| [`browser`](plugins/core-skills/skills/browser/SKILL.md) 📜 📚 | Drives interactive websites in a dedicated signed-in browser window, isolated from the user's other windows. | — |
...
| [`browser`](plugins/core-skills/skills/browser/SKILL.md) 📜 📚 | `core-skills` | Drives interactive websites in a dedicated signed-in browser window, isolated from the user's other windows. | — |
