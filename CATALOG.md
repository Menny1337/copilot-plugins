...
| [`scheduled-skill-review`](plugins/meta/skills/scheduled-skill-review/SKILL.md) 📜 📚 | Manages the macOS daemon that reviews this marketplace's used plugin agents and skills, deploys validated improvements, and reverts regressions. | — |
...
| [`scheduled-skill-review`](plugins/meta/skills/scheduled-skill-review/SKILL.md) 📜 📚 | `meta` | Manages the macOS daemon that reviews this marketplace's used plugin agents and skills, deploys validated improvements, and reverts regressions. | — |
